// Test script to verify streak reward payout via NWC (CommonJS version)
...
let resetStreakDataCompletely, updateUserStreak;
await import('../src/utils/streakUtils.ts').then(mod => {
  resetStreakDataCompletely = mod.resetStreakDataCompletely;
  updateUserStreak = mod.updateUserStreak;
});
