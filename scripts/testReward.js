// Test script to verify streak reward payout via NWC
// Usage: node scripts/testReward.js [recipient]
// recipient can be a lightning address (default thewildhustle@coinos.io) or pubkey

require('dotenv/config');
require('ts-node/register');

// Polyfill a minimal localStorage for Node
...
const { resetStreakDataCompletely, updateUserStreak } = require('../src/utils/streakUtils.ts');
