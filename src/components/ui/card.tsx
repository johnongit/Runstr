...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      // Updated to use design system tokens with mobile-optimized spacing
      "rounded-lg border border-border bg-surface text-text-primary shadow-sm transition-all duration-normal ease-out hover:shadow-md",
      className
    )}
    {...props}
  />
