      ...
      <div className="tab-content">
        {activeTab === 'details' && (
          <div className="event-details mb-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <h2 className="subsection-heading mb-2">Event Details</h2>
              ...
              <div>
                <h2 className="subsection-heading mb-2">How It Works</h2>
                <div className="bg-gray-800 p-4 rounded-md text-gray-300">
        ...
        {activeTab === 'rules' && (
          <div className="event-rules mb-6">
            <h2 className="subsection-heading mb-2">Event Rules</h2>
            <div className="bg-gray-800 p-4 rounded-md text-gray-300">
        ...
        {activeTab === 'register' && (
          <div className="event-registration mb-6">
            <h2 className="subsection-heading mb-2">Register for Event</h2>
      ...
      {showPaymentModal && (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50">
          <div className="bg-gray-800 p-6 rounded-lg max-w-md w-full border border-gray-700">
            <h3 className="subsection-heading mb-4">Payment Required</h3>
